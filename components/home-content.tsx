          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex gap-4 pt-4">
                <Link href="/shop">
                  <Button size="lg" className="shadow-lg shadow-primary/50">Shop Collection</Button>
                </Link>
                <Link href="/about">
                  <Button variant="outline" size="lg" className="border-2">Our Story</Button>
                </Link>
              </div>
            </motion.div>
          </div>
                    ...
                    <CardContent className="p-8">
                      ...
                      <ul className="space-y-2">
                        {category.subcategories.map((sub) => (
                          <li key={sub} className="text-gray-400">{sub}</li>
                        ))}
                      </ul>
                    </CardContent>
                  </Card>
          ...
          <Card className="bg-gradient-to-r from-neon-purple/20 via-neon-pink/20 to-neon-cyan/20 border-2 border-primary/50">
            <CardContent className="p-12 text-center">
              ...
              <Link href="/shop?category=Vaporizers">
                <Button size="lg" className="text-lg">Shop Vaporizers</Button>
              </Link>
            </CardContent>
          </Card>
        </div>
