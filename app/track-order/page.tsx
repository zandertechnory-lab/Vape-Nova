    ...
    return (
        <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-400">Enter your transaction ID to track your order status</p>
            </div>
            ...
            {!order && !loading && (
                <Card>
                    <CardContent className="py-12 text-center">
                        ...
                        <p className="text-gray-400">Enter your transaction ID above to track your order</p>
                    </CardContent>
                </Card>
            )}
        </div>
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="container mx-auto px-4 py-20">
                <Suspense fallback={<div className="h-96 animate-pulse bg-gray-800 rounded max-w-4xl mx-auto" />}>
                    <TrackOrderContent />
                </Suspense>
            </div>
            <Footer />
